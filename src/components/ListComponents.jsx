    ...
    <div className="relative">
      <div className="p-5 max-w-7xl m-auto flex flex-col gap-10 pb-10 lg:pb-20">
        <div className="flex flex-col gap-5 md:justify-between md:flex-row relative z-20">
          ...
          <p className="text-gray-400 text-base md:text-end lg:w-[400px] font-open">
          ...
          {decor.map((item, i) => (
            <div key={i} className="cursor-pointer relative group">
              <img
                src={item.image}
                alt=""
                className="max-w-sm w-full md:max-w-80 relative z-10 hover:z-10 hover:scale-110 duration-500 ease-in-out"
              />
