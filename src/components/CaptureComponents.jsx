      ...
      <div className="pb-10 md:pb-20 lg:pb-28 border-b-2 border-gray-100 relative">
        <div className="flex flex-col gap-10 md:flex-row lg:gap-20 md:justify-between">
          <div className="flex flex-col gap-5 md:w-2/5 lg:w-[25%] md:justify-between relative z-20">
            <h1
              className="font-open text-gray-400 font-medium tracking-wide text-2xl lg:text-3xl"
              data-aos="fade-left"
          ...
          <div className="flex items-center justify-center md:w-[50%] lg:w-[65%] relative z-20" data-aos="zoom-in"
            data-aos-duration="1300">
            <img
              src={capture1}
              alt=""
              className="w-full lg:h-[450px] object-cover object-bottom"
            />
          </div>
